let getCode = (code) => {
  ...
  <title>Mustshark Email Verification</title>
    <style type="text/css">
  /* -------------------------------------
    GLOBAL
  ------------------------------------- */
...
<body bgcolor="#ffffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      <tbody><tr>
        <td background="" bgcolor="#ffffff" width="100%" height="8" valign="top">
          <!--[if gte mso 9]>
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
            <span class="brand">
              <b style="font-size: larger; color: #3677a7;">Mustshark</b>
            </span>
          </div>
        </td>
      </tr>
            ...
            <table cellspacing="0">
              <tbody><tr>
                <td>
                  <table class="soapbox">
                    <tbody><tr>
                      <td class="soapbox-title">Your Password </td>
                    </tr>
                  </tbody></table>
                  <table class="status-container single">
                    <tbody><tr>
                      ...
                      <td>
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tbody><tr>
                            <td class="status-cell">
                              <b style="font-size: xx-large; letter-spacing: 5;">`+ password + `</b>
                            </td>
                          </tr>
                        </tbody></table>
                      </td>
...
module.exports = { getCode, getPassword }
